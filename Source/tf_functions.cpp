...
int run_session (TF_Session* session, const TF_Output* input_operations, TF_Tensor* const* input_tensors, std::size_t num_inputs, const TF_Output* output_operations, TF_Tensor** output_tensors, std::size_t num_outputs)
{
    ...
    TF_SessionRun (session,
                   ...
                   input_operations,
                   input_tensors,
                   static_cast<int> (num_inputs), // Input tensors, input tensor values, number of inputs.
                   output_operations,
                   output_tensors,
                   static_cast<int> (num_outputs), // Output tensors, output tensor values, number of outputs.
                   nullptr,
