...
int run_session (TF_Session* session,
                 const TF_Output* input_operations,
                 TF_Tensor* const* input_tensors,
                 std::size_t num_inputs,
                 const TF_Output* output_operations,
                 TF_Tensor** output_tensors,
                 std::size_t num_outputs);

int run_session (TF_Session* session,
                 const std::vector<TF_Output>& input_operations,
                 const std::vector<TF_Tensor*>& input_tensors,
                 std::size_t num_inputs,
                 const std::vector<TF_Output>& output_operations,
